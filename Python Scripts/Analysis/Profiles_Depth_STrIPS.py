...
for psi in psi0:
    #Path0=<Insert Path to 'Profiles_Domains_STrIPS'>\psi0_'+str('{0:.2f}'.format(psi))
    ...
    for i in range(N_morph):
        ...
        Path=Path0+'\Morphology'+str(i)+'.txt'
        
        Morphology=np.genfromtxt(Path)
